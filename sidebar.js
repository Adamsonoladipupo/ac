...
function create_sidebar () {
    ...
    items_menu.forEach(item => {
        ...
        sidebar_items.appendChild(link);
    });
// ############################# SERVICES SECTION ##########################################
    ...
    sidebar_items.appendChild(sercices_sub_section);
...
// ############################# GIFTING SECTION ##########################################
    ...
    sidebar_items.appendChild(gifting_sub_section);
...
// ############################# API SECTION ##########################################
    ...
    sidebar_items.appendChild(API_sub_section);
    ...
    sidebar_items.appendChild(tools_sub_section);

    // add title name, icon and link to the sidebar items
    const tools_menu = [
        {name: 'Profile', icon:profile_icon, link:'profile.html'},
        {name: 'Setting', icon:settings_icon, link:'settings.html'},
    ];
...
// ------------------------- END OF SUB SECTIONS ------------------------------------
    ...
    logout_link.forEach(item => {
        ...
        sidebar_footer.appendChild(link);
    });

    //3 append sidebar sections into the sidebar container
    sidebar_container.appendChild(sidebar_header);
    sidebar_container.appendChild(sidebar_items);
    sidebar_container.appendChild(sidebar_footer);
